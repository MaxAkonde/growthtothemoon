        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="gjs-ft-column gjs-ft-col-md" id="iexg">
                        <div data-gjs-type="custom-code" class="ft-custom-block" id="c1111">
                            <h1>Privacy Policy for Growth to the Moon</h1>

                            <p>At Growth to the Moon, accessible from growthtothemoon.com, one of our main priorities is
                                the privacy of our visitors. This Privacy Policy document contains types of information that
                                is collected and recorded by Growth to the Moon and how we use it.</p>
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                                website with regards to the information that they shared and/or collect in Growth to the
                                Moon. This policy is not applicable to any information collected offline or via channels
                            ...
                            <p>Growth to the Moon follows a standard procedure of using log files. These files log visitors
                            ...
                            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
                                Growth to the Moon.</p>

                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                                Beacons that are used in their respective advertisements and links that appear on Growth to
                                the Moon, which are sent directly to users' browser. They automatically receive your IP
                            ...
                            <p>Note that Growth to the Moon has no access to or control over these cookies that are used by
                                third-party advertisers.</p>

                            <h2>Third Party Privacy Policies</h2>

                            <p>Growth to the Moon's Privacy Policy does not apply to other advertisers or websites. Thus,
                            ...
                            <p>Growth to the Moon does not knowingly collect any Personal Identifiable Information from
                            ...
                            <p>
                                Chinioti Tech follows a standard procedure of using log files. These files log visitors when
                            ...
                            <p>
                                ...
                                Beacons that are used in their respective advertisements and links that appear on Chinioti
                                Tech, which are sent directly to users' browser. They automatically receive your IP address
                                when this occurs. These technologies are used to measure the effectiveness of their
                                advertising campaigns and/or to personalize the advertising content that you see on websites
                                that you visit.
                                Note that Chinioti Tech has no access to or control over these cookies that are used by
                            ...
                            <p>
                                ...
                                Chinioti Tech's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                            ...
                            <p>
                                ...
                                encourage parents and guardians to observe, participate in, and/or monitor and guide their
                                online activity.
                                Chinioti Tech does not knowingly collect any Personal Identifiable Information from children
